...
This is not a full trace replay lab. It is a Workbench explanation feature that turns existing
governed traces into an operator-readable decision lineage.
