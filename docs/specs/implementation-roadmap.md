...
[P0-01 CI and Runtime Baseline](hardening/p0-01-ci-runtime-baseline.md), currently approved for fresh
implementation planning but not implemented. Later workstreams cover trusted approval identity,
