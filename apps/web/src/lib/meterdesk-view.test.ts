  ...
  "/tickets/TCK-1042/workflows": [
    {
      ...
      origin: "seed_fixture",
      previous_workflow_id: null,
      version: 2,
      transition_sequence: 2,
      created_at: "2026-06-05T12:05:00Z",
      updated_at: "2026-06-05T12:06:00Z",
      started_at: "2026-06-05T12:05:00Z",
      terminal_at: null,
    },
  ],
  "/workflows/WF-TCK-1042-1/transitions": [
    {
      id: "WF-TCK-1042-1-T1",
    ...
    },
    {
      ...
      mock_mutation_id: null,
      created_at: "2026-06-05T12:06:00Z",
    },
  ],
  "/tickets/TCK-1042/agent-runs": [
    {
      ...
      ticket_id: "TCK-1042",
      workflow_id: "WF-TCK-1042-1",
      idempotency_key: "legacy:RUN-2042",
      status: "completed",
      source: "test",
...
const creditRefundPayloads: Record<string, unknown> = {
  ...
  "/tickets/TCK-1137/decision-summary": {
    ...
    workflow_version: 2,
    workflow_status_reason_code: "decision.approval_required",
    workflow_status_reason: "A goodwill credit is waiting for human approval.",
  ...
  "/tickets/TCK-1137/workflows": [
    {
      ...
      updated_at: "2026-06-07T10:06:00Z",
      started_at: "2026-06-07T10:05:00Z",
      terminal_at: null,
    },
  ],
  "/workflows/WF-TCK-1137-1/transitions": [
    {
      id: "WF-TCK-1137-1-T1",
      workflow_id: "WF-TCK-1137-1",
      sequence: 1,
  ...
  "/tickets/TCK-1137/agent-runs": [
    {
      ...
      ticket_id: "TCK-1137",
      workflow_id: "WF-TCK-1137-1",
      idempotency_key: "legacy:RUN-1137",
      status: "completed",
      source: "seeded",
