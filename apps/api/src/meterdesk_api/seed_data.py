...
APPROVALS: list[ApprovalSummary] = [
    ...
    ApprovalSummary(
        ...
        workflow_id="WF-EVAL-TCK-CR-003-1",
        agent_run_id=None,
...
WORKFLOWS = [
    CaseWorkflowSummary(
        ...
        status_reason_code="decision.approval_required",
        status_reason="A duplicate-charge refund is waiting for human approval.",
        origin="seed_fixture",
        version=2,
        transition_sequence=2,
        created_at=utc(2026, 6, 5, 12, 5),
        updated_at=utc(2026, 6, 5, 12, 6),
    ...
    CaseWorkflowSummary(
        ...
        status="awaiting_approval",
        status_reason_code="decision.approval_required",
        status_reason="A goodwill credit is waiting for human approval.",
        origin="seed_fixture",
        version=2,
        transition_sequence=2,
        created_at=utc(2026, 6, 5, 12, 5),
    ...
    CaseWorkflowSummary(
        id="WF-EVAL-TCK-CR-003-1",
        ticket_id="EVAL-TCK-CR-003",
        cycle_number=1,
        status="mock_executed",
        status_reason_code="legacy.mock_executed",
        status_reason="Historical approval and mock mutation were already recorded.",
        origin="legacy",
        version=3,
        transition_sequence=3,
        created_at=utc(2026, 5, 28, 15, 44),
        updated_at=utc(2026, 5, 28, 15, 45),
        started_at=utc(2026, 5, 28, 15, 44),
        terminal_at=utc(2026, 5, 28, 15, 45),
    ),
]
...
WORKFLOW_TRANSITIONS = [
    CaseWorkflowTransitionSummary(
        ...
        actor_source="seed_fixture",
        request_id="seed.p0_03",
        created_at=utc(2026, 6, 5, 12, 5),
    ),
    CaseWorkflowTransitionSummary(
        id="WF-TCK-1042-1-T2",
        ...
        reason_detail="A duplicate-charge refund is waiting for human approval.",
        agent_run_id="RUN-2042",
        approval_request_id="APR-2042",
        actor_source="seed_fixture",
        request_id="seed.p0_03",
    ...
    CaseWorkflowTransitionSummary(
        ...
        to_status="awaiting_approval",
        reason_code="decision.approval_required",
        reason_detail="A goodwill credit is waiting for human approval.",
        agent_run_id="RUN-1137",
        approval_request_id="APR-1137",
        actor_source="seed_fixture",
        request_id="seed.p0_03",
        created_at=utc(2026, 6, 5, 12, 6),
    ),
    CaseWorkflowTransitionSummary(
        id="WF-EVAL-TCK-CR-003-1-T1",
        workflow_id="WF-EVAL-TCK-CR-003-1",
        sequence=1,
        to_status="investigating",
        reason_code="workflow.started",
        actor_source="legacy_unverified",
        request_id="migration.p0_03",
        created_at=utc(2026, 5, 28, 15, 44),
    ),
    CaseWorkflowTransitionSummary(
        id="WF-EVAL-TCK-CR-003-1-T2",
        workflow_id="WF-EVAL-TCK-CR-003-1",
        sequence=2,
        from_status="investigating",
        to_status="awaiting_approval",
        reason_code="legacy.approval_present",
        approval_request_id="APR-EVAL-CR-003-HIST",
        actor_source="legacy_unverified",
        request_id="migration.p0_03",
        created_at=utc(2026, 5, 28, 15, 44),
    ...
    CaseWorkflowTransitionSummary(
        id="WF-EVAL-TCK-CR-003-1-T3",
        workflow_id="WF-EVAL-TCK-CR-003-1",
        sequence=3,
        from_status="awaiting_approval",
        to_status="mock_executed",
        reason_code="legacy.mock_executed",
        approval_request_id="APR-EVAL-CR-003-HIST",
        mock_mutation_id="MM-EVAL-CR-003-HIST",
        actor_source="legacy_unverified",
        request_id="migration.p0_03",
        created_at=utc(2026, 5, 28, 15, 45),
    ),
]
